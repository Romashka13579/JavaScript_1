...
txt = "Choose what do you want:"
txt1 = "1.Your birthday date."
txt2 = "2.Programm that divisible your number."
txt3 = "3.Random numbers."
txt4 = "4.The Casino."
a = prompt(""+ txt +" "+ txt1 +" "+ txt2 +" "+ txt3 +" "+ txt4 +"")
switch (a){
    case "1":
        first(a, txt)
        break
...
function fourth(txt, txt1, a, rand, b) {
